window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function FeatureHeader(props) {
      return React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 14 } },
    ...
    function UsagePanel() {
      ...
      var children = [];
      children.push(React.createElement(FeatureHeader, { key: "head", label: zh("Usage", "用量"), enabled: true, busy: toggleBusy, action: disableUsage }));
    ...
    function MemoryPanel() {
      ...
      var headChildren = React.createElement(FeatureHeader, { key: "head", label: zh("Memory", "记忆"), enabled: true, busy: toggleBusy, action: disableMemory });
