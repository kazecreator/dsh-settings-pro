  ...
  factory: (require) => {
    ...
    function AboutPanel() {
      ...
      var rows = [
        ...
        { k: zh("Install", "安装方式"), v: snap == null ? "…" : isFile ? zh("Local dev (file:)", "本地开发（file:）") : "npm registry" },
      ];
      ...
      if (actionErr) actions.push(React.createElement("span", { key: "err", style: imErrStyle }, actionErr));
