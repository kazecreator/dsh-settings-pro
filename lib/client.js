window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function UsagePanel() {
      ...
      var children = [];
      children.push(React.createElement("div", { key: "head", style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 } },
        React.createElement("span", { style: { color: T.textTertiary, fontSize: 12 } }, zh("Usage", "用量") + " · " + zh("Enabled", "已启用")),
        React.createElement(P.Button, { variant: "primary", size: "sm", disabled: toggleBusy, onClick: disableUsage }, zh("Disable", "关闭"))));
    ...
    function MemoryPanel() {
      ...
      var headChildren = React.createElement("div", { key: "head", style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 } },
        React.createElement("span", { style: { color: T.textTertiary, fontSize: 12 } }, zh("Memory", "记忆") + " · " + zh("Enabled", "已启用")),
        React.createElement(P.Button, { variant: "primary", size: "sm", disabled: toggleBusy, onClick: disableMemory }, zh("Disable", "关闭")));
