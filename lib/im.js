...
class ImController {
  ...
  constructor(ctx, patchConfig, vision = null) {
    this.#ctx = ctx;
    this.#patchConfig = patchConfig;
    this.#configPath = runtimeConfigPath();
    this.#runtimeConfig = this.#loadRuntimeConfig();
    this.#status = new ImStatus();
    this.#bridge = new ImBridge(ctx, { ...this.#patchConfig, ...this.#runtimeConfig }, vision);
  }
 ...
 */
export function startIm(ctx, config, vision = null) {
  const controller = new ImController(ctx, config ?? {}, vision);
