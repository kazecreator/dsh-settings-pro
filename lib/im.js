...
class ImController {
  ...
  constructor(ctx, patchConfig, userRegistry = null) {
    this.#ctx = ctx;
    this.#patchConfig = patchConfig;
    this.#configPath = runtimeConfigPath();
    this.#runtimeConfig = this.#loadRuntimeConfig();
    this.#status = new ImStatus();
    this.#bridge = new ImBridge(ctx, { ...this.#patchConfig, ...this.#runtimeConfig }, userRegistry);
  }
 ...
 */
export function startIm(ctx, config, userRegistry = null) {
  const controller = new ImController(ctx, config ?? {}, userRegistry);
