...
<style>
  ...
  #bubble { position: absolute; bottom: 96px; left: 50%; transform: translateX(-50%); width: max-content; min-width: 140px; background: rgba(255,255,255,.96); border: 1px solid #e2e2e2; border-radius: 10px; padding: 5px 10px; font-size: 12px; line-height: 16px; color: #333; box-shadow: 0 2px 8px rgba(0,0,0,.15); max-width: 300px; text-align: left; }
